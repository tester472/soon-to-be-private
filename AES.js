...
string = `dispite the laws of this land my heart and will 
aches for you. I will and always have loved you. 
Now more than ever`
encrypted_message = ""
messageArray = messageToArrays(string)
for(x=0;x<messageArray.length;x++)
{
  message = messageArray[x]
  message= XORKey(message,key[0])
  for(i=1;i<10;i++)
  {
  ...
  message= byte_sub(message)
  message = shiftRow(message)
  message = XORKey(message,key[10])
  message_string = checkArray(message)
  encrypted_message += message_string
}
console.log(encrypted_message)
 encrypted_numbers = "" + encrypted_message[0].charCodeAt()
for(let i = 1; i < encrypted_message.length;i++)
{
  encrypted_numbers+= "," + encrypted_message[i].charCodeAt()
}
console.log(encrypted_numbers)
